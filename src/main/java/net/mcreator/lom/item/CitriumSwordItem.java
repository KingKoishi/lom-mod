...
public class CitriumSwordItem extends LomModElements.ModElement {
	@ObjectHolder("lom:citrium_sword")
	public static final Item block = null;
	public CitriumSwordItem(LomModElements instance) {
		super(instance, 27);
	}
