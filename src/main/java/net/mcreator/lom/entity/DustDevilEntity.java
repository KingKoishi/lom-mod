...
import net.mcreator.lom.procedures.DustDevilOnInitialEntitySpawnProcedure;
import net.mcreator.lom.particle.DustDevilSmokeParticle;
import net.mcreator.lom.itemgroup.LOMCreaturesItemGroup;
import net.mcreator.lom.entity.renderer.DustDevilRenderer;
...
public class DustDevilEntity extends LomModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -532549, -4649, new Item.Properties().group(LOMCreaturesItemGroup.tab))
				.setRegistryName("dust_devil_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 50, 3, 4));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				DustDevilOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 3; ++l) {
					...
					world.addParticle(DustDevilSmokeParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
