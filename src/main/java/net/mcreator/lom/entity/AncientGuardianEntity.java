...
import net.mcreator.lom.procedures.AncientGuardianEntityDiesProcedure;
import net.mcreator.lom.entity.renderer.AncientGuardianRenderer;
...
public class AncientGuardianEntity extends LomModElements.ModElement {
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.22);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				AncientGuardianEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
