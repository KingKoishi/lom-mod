...
import net.mcreator.lom.procedures.YellowShardLizardOnInitialEntitySpawnProcedure;
import net.mcreator.lom.itemgroup.LOMCreaturesItemGroup;
import net.mcreator.lom.entity.renderer.YellowShardLizardRenderer;
...
public class YellowShardLizardEntity extends LomModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9180, -3065, new Item.Properties().group(LOMCreaturesItemGroup.tab))
				.setRegistryName("yellow_shard_lizard_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 50, 2, 4));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				YellowShardLizardOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
